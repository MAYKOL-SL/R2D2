        ...
        <div class="col" style="padding: 25px;">
          <div class="box box-primary">
            <div class="box-body no-padding">
              ...
              <div class="container">
                {!! Form::open(['route' => 'calendario_docente_secre_aux.store', 'method' => 'post', 'role' => 'form']) !!}
            ...
            <div id="modal-event" class="modal fade" tabindex="-1" data-backdrop="static" >
                ...
                <div class="modal-dialog" style="background: #ffffff;">
                    ...
                    <div class="modal-footer">
                           <a id="delete" data-href="{{ url('calendario_docente_secre_aux') }}" data-id="" class="btn btn-danger" data-dismiss="modal">Eliminar</a>
