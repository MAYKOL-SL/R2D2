...
class PorHoraController extends Controller
{
    ...
    public function index(Request $request)
    {
        if($request)
        {
            ...
            return view('porHora.index',["fechaActual"=>$fechaActual,"periodo"=>$periodo,"ambientes"=>$ambientes,"periodoBuscado"=>$periodoBuscado, "fechaIni"=>$fechaIni,"fechaFin"=>$fechaFin]);
        }
